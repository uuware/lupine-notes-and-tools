...
const resourcesPath = app.isPackaged
  ? 'resources/app.asar/dist/server_root/lupine-notes-and-tools_web/'
  : 'dist/server_root/lupine-notes-and-tools_web/';
...
async function createWindow() {
  ...
  mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      // preload: 'apps/lupine-notes-and-tools/electron/builder.json',
  ...
  // await mainWindow.loadFile('dist/server_root/lupine-notes-and-tools_web/index.html')
...
//     filePath += 'index.html';
//   }
//   let srcPath = path.join('resources/app.asar/dist/server_root/lupine-notes-and-tools_web/', filePath);
//   try {
